...
static const Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_r,         spawn,          {.v = (const char*[]){ "pcmanfm", NULL } } },
    { MODKEY,                       XK_y,         spawn,          {.v = (const char*[]){ TERMINAL, "-e", "taskwarrior-tui", NULL } } },
    { MODKEY,                       XK_BackSpace, spawn,          {.v = (const char*[]){ "powermenu", NULL } } },
    ...
    { MODKEY,                       XK_F8,        spawn,          {.v = (const char*[]){ "rssadd", NULL } } },
